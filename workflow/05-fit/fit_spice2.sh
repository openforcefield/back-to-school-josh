...
#SBATCH --error=slurm_%x_%j-%J.err   ## error log file
#SBATCH --output=slurm_%x_%j-%J.out  ## output log file
...
mkdir spice2-fit1
pixi run -e cuda mamba env export > spice2-fit1/solved-env.yml

pixi run -e cuda python fit.py                                                 \
